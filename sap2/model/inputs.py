...
class InputBundle:
    ...
    def __post_init__(self):
        ...
        if actual != expected:
            ...
            raise ValueError(
                f"InputBundle must have exactly E,Δ,S,V,M,R. {', '.join(msg)}"
            )

    def get(self, family: str) -> Input:
        """
        Accessor for input families.
        ...
        ------
        KeyError
            If the family is not present.
        """
        return self.inputs[family]
